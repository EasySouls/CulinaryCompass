...
import dev.easysouls.culinarycompass.CulinaryDestinations
import dev.easysouls.culinarycompass.CulinaryNavigationActions
...
fun AppModalDrawer(
    ...
    currentRoute: String,
    navigateActions: CulinaryNavigationActions,
...
fun AppDrawer(
    ...
    Column(modifier = modifier.fillMaxSize()) {
        ...
        DrawerButton(
            ...
            isSelected = currentRoute == CulinaryDestinations.STATISTICS_ROUTE,
            action = {
